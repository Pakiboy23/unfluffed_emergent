        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Our <span className="text-neon-green">Actually Useful</span> Kits
            </h2>
            <p className="text-xl text-gray-400">
              Two kits. Tested by real humans. Zero fluff.
            </p>
          </div>
            ...
            <div className="bg-gray-800 rounded-2xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 group border border-gray-700 hover:border-neon-green">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-400 mb-6">
                  ...
                  Actual humans tested this stuff.
                </p>
            ...
            <div className="bg-gray-800 rounded-2xl overflow-hidden hover:transform hover:scale-105 transition-all duration-300 group border border-gray-700 hover:border-neon-green">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-400 mb-6">
                  ...
                  no "aesthetic" crap that breaks in a week.
                </p>
                <div className="flex items-center justify-between">
                  <div className="text-neon-green font-semibold">
                    <span className="text-2xl">★★★★★</span>
